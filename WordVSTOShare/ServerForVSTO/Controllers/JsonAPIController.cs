...
namespace ServerForVSTO.Controllers
{
    public class JsonAPIController : Controller
    {
        ...
        public ActionResult GetList(ScreenResultModel screen)
        {
            ...
            IQueryable<BaseTemplet> templets = util.GetScreenResult(user, screen, out int totalcount);
            List<BaseTemplet> temp = templets.ToList();
            List<TempletForJson> result = new List<TempletForJson>();
